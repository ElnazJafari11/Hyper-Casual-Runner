...
namespace HyperCasualRunner.Editor
{
    ...
    public static class IdleToolkitSliceGenerator
    {
        ...
        private static readonly SliceDef[] Slices =
        {
            ...
            new SliceDef { FileName = "06_AntimatterDimensions_Layers", Archetype = IdleArchetype.AntimatterDimensions, DisplayName = "Antimatter Dimensions", HowTo = "Buy the single Dim → click antimatter → Prestige Layer advances named bands (Dimension/Infinity/Eternity/Reality). Multi-Dim tiers are TODO STUB.", StartCurrency = 10, ClickPower = 1 },
            new SliceDef { FileName = "07_RealmGrinder_Factions", Archetype = IdleArchetype.RealmGrinder, DisplayName = "Realm Grinder", HowTo = "Build → Align Good/Evil (first free; re-pick costs PrimaryCurrency) → Rebirth keeps faction.", StartCurrency = 20, ClickPower = 1 },
